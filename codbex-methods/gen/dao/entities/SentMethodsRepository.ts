...
export class SentMethodsRepository {
    ...
    private async triggerEvent(data: SentMethodsEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-methods/entities/SentMethods", ["trigger"]);
        ...
        producer.queue("codbex-methods/entities/SentMethods").send(JSON.stringify(data));
    }
}