...
export class PaymentMethodRepository {
    ...
    private async triggerEvent(data: PaymentMethodEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-methods/entities/PaymentMethod", ["trigger"]);
        ...
        producer.queue("codbex-methods/entities/PaymentMethod").send(JSON.stringify(data));
    }
}